...
class OcupacionView(viewsets.ModelViewSet):
    ...
    def list(self, request):
        query = OcupacionModel.objects.all()
        serializer = OcupacionSerializer(query, many=True)

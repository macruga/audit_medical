...
from core.serializers.soporte.escolaridad import EscolaridadSerializer


"""
@desc: Vista de consulta de escolaridad
...
class EscolaridadView(viewsets.ModelViewSet):
    ...
    # permission_classes = ()
    queryset = EscolaridadModel.objects.all()
    ...
    def list(self, request):
        query = EscolaridadModel.objects.all()
        serializer = EscolaridadSerializer(query, many=True)

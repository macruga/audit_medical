...
# Ambito procedimientos Model 
class AmbitoProcedimientoModel(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='user_create_ambito_procedimiento', on_delete=models.PROTECT)

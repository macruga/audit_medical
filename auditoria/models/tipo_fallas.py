...
# modelo de Fallas para la Auditoria
class tipoFallasAuditoriaModel (models.Model):
    '''
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='user_create_tipo_falla_auditoria', on_delete=models.PROTECT)

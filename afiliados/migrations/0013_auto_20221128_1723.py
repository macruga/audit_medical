# Generated by Django 3.0.10 on 2022-11-28 17:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('afiliados', '0012_auto_20221128_1606'),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='afiliacionmodel',
            constraint=models.CheckConstraint(check=models.Q(fecha_vencimiento__gt=django.db.models.expressions.F('fecha_afiliacion')), name='La fecha de vencimiento no puede ser menor o igual a la fecha de afiliacion'),
        ),
    ]
